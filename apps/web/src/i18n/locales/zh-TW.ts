...
export const zhTW: Dict = {
  ...
  'settings.healthcheck.button': "體檢",
  'settings.healthcheck.run': "執行設定體檢",
  'settings.healthcheck.rerun': "重新體檢",
  'settings.healthcheck.overall.pass': "運作正常",
  'settings.healthcheck.overall.warn': "可用但有警告",
  'settings.healthcheck.overall.fail': "需要處理",
  'settings.healthcheck.check.detected': "偵測",
  'settings.healthcheck.check.invocable': "可執行",
  'settings.healthcheck.check.authenticated': "登入狀態",
  'settings.healthcheck.check.smoke': "連通測試",
};
