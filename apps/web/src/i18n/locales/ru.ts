...
export const ru: Dict = {
  ...
  'settings.healthcheck.button': "Health check",
  'settings.healthcheck.run': "Run a configuration health check",
  'settings.healthcheck.rerun': "Re-run health check",
  'settings.healthcheck.overall.pass': "Healthy",
  'settings.healthcheck.overall.warn': "Usable with warnings",
  'settings.healthcheck.overall.fail': "Action needed",
  'settings.healthcheck.check.detected': "Detected",
  'settings.healthcheck.check.invocable': "Runs",
  'settings.healthcheck.check.authenticated': "Sign-in",
  'settings.healthcheck.check.smoke': "Smoke test",
};
