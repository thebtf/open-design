...
export const zhCN: Dict = {
  ...
  'settings.healthcheck.button': "体检",
  'settings.healthcheck.run': "运行配置体检",
  'settings.healthcheck.rerun': "重新体检",
  'settings.healthcheck.overall.pass': "运行正常",
  'settings.healthcheck.overall.warn': "可用但有警告",
  'settings.healthcheck.overall.fail': "需要处理",
  'settings.healthcheck.check.detected': "检测",
  'settings.healthcheck.check.invocable': "可运行",
  'settings.healthcheck.check.authenticated': "登录状态",
  'settings.healthcheck.check.smoke': "连通测试",
};
